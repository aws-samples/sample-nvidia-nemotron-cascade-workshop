 ...
 * the exact day-of values once confirmed on Bedrock us-west-2.
 */
export const MODELS = {
  ...
  // Opus 4.7 — judge for the bake-off ground truth. Strongest model on
  ...
  // availability — add as MODELS.NEMOTRON_ULTRA once the foundation-model
  // ID is live in us-west-2.
